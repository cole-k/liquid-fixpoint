...
(wvar $wk$mwe__wkvar_kvar_interaction__row_op$1 (int int))  ;; weak kvar: WKVid { parent_fn: DefId(0:39 ~ failures[7370]::mwe::wkvar_kvar_interaction::row_op), id: $k1 }
        ...
        (and
         ...
         (forall ((a1 int) (true))
          (forall ((_invariant$ int) ((>= a1 0)))
           (forall ((_$ int) ($wk$mwe__wkvar_kvar_interaction__row_op$1 a1 reftgen$m$0))
            ($k0 a1 reftgen$m$0)))))))))))))
